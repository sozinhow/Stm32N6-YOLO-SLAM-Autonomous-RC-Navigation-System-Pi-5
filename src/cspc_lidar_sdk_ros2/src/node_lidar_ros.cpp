...
public:
  MinimalSubscriber()
  : Node("cspc_lidar_status_listener")
  {
...
/* 处理最新一圈雷达的数据 */
static void Scan_to_PointCloud(LaserScan &scan, sensor_msgs::msg::PointCloud2 &outscan)
{
...
int main(int argc, char **argv)
{
  ...
  // Jazzy needs typed declare_parameter with defaults
  ...
  node->declare_parameter<std::string>("frame_id", "base_laser");
